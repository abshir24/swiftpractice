...
print("Abshir ")
print("Mohamed")
print("I don't have any social media")
...
var myAge = 22
let myName = "Abshir"
var mySchool = "Green River College"
...
//1.var total = 0
//2. let pi = 3.14159
//3. var players, let players. It could be a variable or a constant
//4. The user's number of followers and people being followed
//5. The user's 
 ...
 */
// Create values here
var grade: String = "3.0"

let building: Int = 30

let double: Double = 100
...
// Write your code here:
 ...
 //1.We store text in strings variables because strings are arrays of characters so this only makes
 //sense.
 //2.Life fam
 ...
 */
// Write your code here:
//1. an example of an if statement would be if there is only one condition
//2. and example of using an if/else statement be in cases that are more than one condintion
//3. an example of switch statement would be in cases where there is only
...
print("It took me  \(count) times to find my favorite number \(fave)")
/*:
 ## More Practice
 ...
 */
// Write your code here:
var names: [String] = ["Morjan","Jamela","Aden","Ahmed","Hoyo Macaan"]
...
var familyAges: [String: Int] = ["Morjan": 32, "Ahmed": 34, "Jamela": 24, "Aden":28, "Hoyo Macaan": 53]
...
for index in 0...length-1{
    if(frequency[fives[index]] == nil)
    {
        frequency[fives[index]] = 1;
    }else{
        frequency[fives[index]]! += 1
    }
}
...
for i in 0...length-1{
    ...
    print("Number: \(fives[i]) Frequency: \(frequency[fives[i]])")
